...
var demo2UI=(function(_super){
		function demo2UI(){
			
		    this.button1=null;

			demo2UI.__super.call(this);
		}

		CLASS$(demo2UI,'ui.test.demo2UI',_super);
		var __proto__=demo2UI.prototype;
		__proto__.createChildren=function(){
		    
			laya.ui.Component.prototype.createChildren.call(this);
			this.createView(demo2UI.uiView);

		}

		demo2UI.uiView={"type":"View","props":{"width":600,"height":400},"child":[{"type":"Button","props":{"y":189,"x":81,"var":"button1","skin":"comp/button.png","label":"label"}}]};
		return demo2UI;
	})(View);
