...
(function (ui) {
    ...
    (function (test) {
        var demoUI = /** @class */ (function (_super) {
            ...
            demoUI.uiView = { "type": "View", "props": { "width": 600, "height": 400 }, "child": [{ "type": "Button", "props": { "y": 183, "x": 120, "var": "btn1", "skin": "comp/button.png", "name": "rank", "label": "label" } }, { "type": "Button", "props": { "y": 227, "x": 120, "var": "btn2", "skin": "comp/button.png", "name": "user", "label": "label" } }] };
            return demoUI;
        }(View));
        test.demoUI = demoUI;
